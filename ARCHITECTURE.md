...
| `src/PlayingGame/Quests.lua` | Apocalypse Quest engine, quest state, offer flow, rewards and interactions. Quest-specific exceptions register through the local handler registry; shared combat-step identity is metadata-driven, and card UI actions route through focused action-family handlers. |
