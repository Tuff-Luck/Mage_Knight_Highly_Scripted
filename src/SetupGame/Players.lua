...
local function playerSetupPositionNeeded(position,context)
	return (gStates.positionMageKnight[position]~="nobody" and position<=4) or
...
function playerSetup()
	local context={
		mirrorExpected=playerSetupInitializeState(),
		mirrorReady=0,
		dummyPlayed=0,
		startPos={0,0,0,0,0}
	}
